...
int read_file_content(const char *filename, char **content, int *content_length){

    FILE *file = NULL;
    int is_error = 0, readed_chars_count;
...
int load_int_array_from_file(const char *filename, int **array, int *array_size){
    ...
    int spaces_count = 0, is_error = 0, content_length, i, ret_val;
...
int load_string_array_from_file(const char *filename, int max_string_size, UT_array **array, int *array_size){
    ...
    char *content = NULL, *token = NULL, *delims = "\n";
    int elements_count = 0, is_error = 0, content_length, i, ret_val;
...
int write_content_to_file(const char *filename, char *content, int content_length){
